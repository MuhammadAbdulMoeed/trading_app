      ...
      <div class="navbar-wrapper">
        <div class="navbar-header d-md-none">
          <ul class="nav navbar-nav flex-row">
            ...
            <li class="nav-item d-md-none"><a class="navbar-brand" href="{{url('/dashboard')}}"><img class="brand-logo d-none d-md-block" alt="CryptoDash admin logo" src="{{asset('admin-assets/images/logo/logo.png')}}">
                    <img class="brand-logo d-sm-block d-md-none" alt="CryptoDash admin logo sm"
			src="{{asset('admin-assets/images/logo/logo-sm.png')}}"></a></li>
            ...
            <ul class="nav navbar-nav float-right">
              ...
              <li class="dropdown dropdown-user nav-item">
                  <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                      <span class="avatar avatar-online"><img src="{{asset('admin-assets/images/portrait/small/avatar-s-1.png')}}" alt="avatar"></span>
{{--                      <span class="mr-1">{{auth()->user()->name ?? ""}}<span class="user-name text-bold-700"></span></span>--}}
                  </a>
                <div class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item" href="account-profile.html"><i class="ft-award"></i>{{auth()->user()->name ?? ""}}</a>
                 {{-- <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="account-profile.html"><i class="ft-user"></i> Profile</a>
                    <a class="dropdown-item" href="wallet.html"><i class="icon-wallet"></i> My Wallet</a>
                    <a class="dropdown-item" href="transactions.html"><i class="ft-check-square"></i> Transactions --}}             </a>
                  <div class="dropdown-divider"></div>
